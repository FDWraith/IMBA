...
public class Generator {
  ...
  private Block initializeBlock(int ID) {
    switch(ID) {
    case 0: 
      return new AirBlock(80, ID);
    case 1: 
      return new SolidBlock("dirt.jpg", 80, ID);
    case 2: 
      return new FallingBlock("gravel.jpg", 80, ID);
    case 3: 
      return new SolidBlock("stone_brick.jpg", 80, ID);
    case 4: 
      return new SolidBlock("wood.jpg", 80, ID);
    case 5: 
      return new EndBlock(80, ID);
    case 6: 
      return new CoinBlock(80, ID);
    case 7: 
      return new SlidingBlock("platform.jpg", 80, ID);
    }
    return null;
  }
